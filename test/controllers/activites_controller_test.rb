...
class ActivitesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create activite" do
    assert_difference("Activite.count") do
      post activites_url, params: { activite: { date_debut: @activite.date_debut, date_fin: @activite.date_fin, description: @activite.description, projet_id: @activite.projet_id, titre: @activite.titre } }
    end
  ...
  test "should update activite" do
    patch activite_url(@activite), params: { activite: { date_debut: @activite.date_debut, date_fin: @activite.date_fin, description: @activite.description, projet_id: @activite.projet_id, titre: @activite.titre } }
